(function($) {
	$(function() {
		...
		function specialActive(time) {
			switch(turn) {
				case BLACK:
					if(turn_count >= super_count && super_activated_black == false) setTimeout(function() {
						$('#button_super_black').removeClass('inactive');
						super_activated_black = true;
					}, time);
					if(turn_count >= double_count && double_activated_black == false) setTimeout(function() {
						$('#button_double_black').removeClass('inactive');
						double_activated_black = true;
					}, time);
					if(turn_count >= miracle_count && miracle_activated_black == false) setTimeout(function() {
						$('#button_miracle_black').removeClass('inactive');
						miracle_activated_black = true;
					}, time);
					break;
				case WHITE:
					if(turn_count >= super_count && super_activated_white == false) setTimeout(function() {
						$('#button_super_white').removeClass('inactive');
						super_activated_white = true;
					}, time);
					if(turn_count >= double_count && double_activated_white == false) setTimeout(function() {
						$('#button_double_white').removeClass('inactive');
						double_activated_white = true;
					}, time);
					if(turn_count >= miracle_count && miracle_activated_white == false) setTimeout(function() {
		...
		function buttonSuper(id) {
			...
			switch(turn) {
				case BLACK:
					...
					if(button_super_black) $('#button_super_black').addClass('on_special');
					break;
				case WHITE:
					...
					$('button').removeClass('on_special');
					if(button_super_white) $('#button_super_white').addClass('on_special');
					break;
			}
			specialControl(id);
		}
		...
		function buttonDouble(id) {
			...
			switch(turn) {
				case BLACK:
					...
					$('button').removeClass('on_special');
					if(button_double_black) $('#button_double_black').addClass('on_special');
					break;
				case WHITE:
					...
					$('button').removeClass('on_special');
					if(button_double_white) $('#button_double_white').addClass('on_special');
					break;
			}
			specialControl(id);
		}
		...
		function buttonMiracle(id) {
			...
			switch(turn) {
				case BLACK:
					...
					$('button').removeClass('on_special');
					if(button_miracle_black) $('#button_miracle_black').addClass('on_special');
					break;
				case WHITE:
					...
					$('button').removeClass('on_special');
					if(button_miracle_white) $('#button_miracle_white').addClass('on_special');
					break;
			}
			specialControl(id);
		}
		...
		function closeModal() {
			...
			setTimeout(function() {$('button').removeClass('silent_inactive');}, 500);
		}
