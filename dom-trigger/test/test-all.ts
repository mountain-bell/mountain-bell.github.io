import DomTrigger, { type DomTriggerData } from "../dist/index.js";
...
interface SetLogData extends DomTriggerData {
	id?: number;
	name?: string;
}

dt.use<SetLogData>("set-log", ({ data, el, ctx }) => {
...
dt.use<SetLogData>("set-log-invoke-no-data", ({ data }) => {
...
dt.run<SetLogData>("set-log", { data: { id: 2, name: "run_add_data" } });
